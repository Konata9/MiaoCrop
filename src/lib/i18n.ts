...
const messages = {
  en: {
    ...
    'export.cover.extension': 'Chrome Extension Promo',
    'export.cover.store': 'Chrome Web Store Cover',
    ...
    'editor.dropToReplace': 'Drop image here to replace',
  ...
  'zh-CN': {
    ...
    'export.cover.extension': 'Chrome 插件推广图',
    'export.cover.store': 'Chrome 商店封面',
  ...
  'ja': {
    ...
    'export.cover.extension': 'Chrome 拡張機能プロモ',
    'export.cover.store': 'Chrome ストアカバー',
    ...
    'editor.dropToReplace': '画像をドロップして置換',
